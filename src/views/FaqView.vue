...
<template>
  <div class="bg-gray-100 min-h-screen">
    <Nav />
    <div class="p-8">
      <h1 class="text-4xl font-bold mb-8 text-center">FAQ</h1>
      <div ref="dropdownStudy" class="dropdown mb-4 p-4 bg-white shadow rounded-lg" @click.stop>
        <div class="flex justify-between items-center cursor-pointer" @click="showStudy = !showStudy">
          <strong class="dropdown-label text-xl">Quali sono i primi passi per imparare a creare siti web?</strong>
          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" :class="{'rotate-180': showStudy, 'ml-2': true, 'w-6': true, 'h-6': true, 'transition-transform': true}">
            <path stroke-linecap="round" stroke-linejoin="round" d="m19.5 8.25-7.5 7.5-7.5-7.5" />
          </svg>
        </div>
        <p class="dropdown-content mt-2" v-if="showStudy">
      ...
      <div ref="dropdownFramework" class="dropdown mb-4 p-4 bg-white shadow rounded-lg" @click.stop>
        <div class="flex justify-between items-center cursor-pointer" @click="showFramework = !showFramework">
          <strong class="dropdown-label text-xl">Cosa sono i framework frontend e mi servono?</strong>
          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" :class="{'rotate-180': showFramework, 'ml-2': true, 'w-6': true, 'h-6': true, 'transition-transform': true}">
            <path stroke-linecap="round" stroke-linejoin="round" d="m19.5 8.25-7.5 7.5-7.5-7.5" />
          </svg>
        </div>
        <p class="dropdown-content mt-2" v-if="showFramework">
      ...
      <div ref="dropdownMobile" class="dropdown mb-4 p-4 bg-white shadow rounded-lg" @click.stop>
        <div class="flex justify-between items-center cursor-pointer" @click="showMobile = !showMobile">
          <strong class="dropdown-label text-xl">Quale linguaggio serve per creare applicazioni mobile?</strong>
          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" :class="{'rotate-180': showMobile, 'ml-2': true, 'w-6': true, 'h-6': true, 'transition-transform': true}">
            <path stroke-linecap="round" stroke-linejoin="round" d="m19.5 8.25-7.5 7.5-7.5-7.5" />
          </svg>
        </div>
        <p class="dropdown-content mt-2" v-if="showMobile">
      ...
      <div ref="dropdownGames" class="dropdown mb-4 p-4 bg-white shadow rounded-lg" @click.stop>
        <div class="flex justify-between items-center cursor-pointer" @click="showGames = !showGames">
          <strong class="dropdown-label text-xl">Come posso imparare a creare giochi?</strong>
          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" :class="{'rotate-180': showGames, 'ml-2': true, 'w-6': true, 'h-6': true, 'transition-transform': true}">
            <path stroke-linecap="round" stroke-linejoin="round" d="m19.5 8.25-7.5 7.5-7.5-7.5" />
          </svg>
        </div>
        <p class="dropdown-content mt-2" v-if="showGames">
      ...
      <div ref="dropdownBestLanguage" class="dropdown mb-4 p-4 bg-white shadow rounded-lg" @click.stop>
        <div class="flex justify-between items-center cursor-pointer" @click="showBestLanguage = !showBestLanguage">
          <strong class="dropdown-label text-xl">Qual è il miglior linguaggio di programmazione per iniziare?</strong>
          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" :class="{'rotate-180': showBestLanguage, 'ml-2': true, 'w-6': true, 'h-6': true, 'transition-transform': true}">
            <path stroke-linecap="round" stroke-linejoin="round" d="m19.5 8.25-7.5 7.5-7.5-7.5" />
          </svg>
        </div>
        <p class="dropdown-content mt-2" v-if="showBestLanguage">
      ...
      <div ref="dropdownSelfTaught" class="dropdown mb-4 p-4 bg-white shadow rounded-lg" @click.stop>
        <div class="flex justify-between items-center cursor-pointer" @click="showSelfTaught = !showSelfTaught">
          <strong class="dropdown-label text-xl">È possibile diventare sviluppatore da autodidatta?</strong>
          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" :class="{'rotate-180': showSelfTaught, 'ml-2': true, 'w-6': true, 'h-6': true, 'transition-transform': true}">
            <path stroke-linecap="round" stroke-linejoin="round" d="m19.5 8.25-7.5 7.5-7.5-7.5" />
          </svg>
        </div>
        <p class="dropdown-content mt-2" v-if="showSelfTaught">
      ...
      <div ref="dropdownUniversity" class="dropdown mb-4 p-4 bg-white shadow rounded-lg" @click.stop>
        <div class="flex justify-between items-center cursor-pointer" @click="showUniversity = !showUniversity">
          <strong class="dropdown-label text-xl">L'università è necessaria?</strong>
          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" :class="{'rotate-180': showUniversity, 'ml-2': true, 'w-6': true, 'h-6': true, 'transition-transform': true}">
            <path stroke-linecap="round" stroke-linejoin="round" d="m19.5 8.25-7.5 7.5-7.5-7.5" />
          </svg>
        </div>
        <p class="dropdown-content mt-2" v-if="showUniversity">
      ...
      <div ref="dropdownAcademy" class="dropdown mb-4 p-4 bg-white shadow rounded-lg" @click.stop>
        <div class="flex justify-between items-center cursor-pointer" @click="showAcademy = !showAcademy">
          <strong class="dropdown-label text-xl">Le Code Academy costose valgono l'investimento?</strong>
          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" :class="{'rotate-180': showAcademy, 'ml-2': true, 'w-6': true, 'h-6': true, 'transition-transform': true}">
            <path stroke-linecap="round" stroke-linejoin="round" d="m19.5 8.25-7.5 7.5-7.5-7.5" />
          </svg>
        </div>
        <p class="dropdown-content mt-2" v-if="showAcademy">
