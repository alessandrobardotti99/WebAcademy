  ...
  <div class="bg-gray-100 min-h-screen">
    ...
    <div class="p-8">
      ...
      <div ref="dropdownStudy" class="dropdown mb-4 p-4 bg-white shadow rounded-lg" @click.stop>
        ...
        <p class="dropdown-content mt-2 p-4 bg-neutral-100 rounded-xl" v-if="showStudy">
      ...
      <div ref="dropdownFramework" class="dropdown mb-4 p-4 bg-white shadow rounded-lg" @click.stop>
        <div class="flex justify-between items-center cursor-pointer" @click="showFramework = !showFramework">
          ...
          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="#ffd06a" :class="{'rotate-180': showFramework, 'ml-2': true, 'w-6': true, 'h-6': true, 'transition-transform': true}">
            <path stroke-linecap="round" stroke-linejoin="round" d="m19.5 8.25-7.5 7.5-7.5-7.5" />
          </svg>
        </div>
        <p class="dropdown-content mt-2 p-4 bg-neutral-100 rounded-xl" v-if="showFramework">
      ...
      <div ref="dropdownMobile" class="dropdown mb-4 p-4 bg-white shadow rounded-lg" @click.stop>
        <div class="flex justify-between items-center cursor-pointer" @click="showMobile = !showMobile">
          ...
          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="#ffd06a" :class="{'rotate-180': showMobile, 'ml-2': true, 'w-6': true, 'h-6': true, 'transition-transform': true}">
            <path stroke-linecap="round" stroke-linejoin="round" d="m19.5 8.25-7.5 7.5-7.5-7.5" />
          </svg>
        </div>
        <p class="dropdown-content mt-2 p-4 bg-neutral-100 rounded-xl" v-if="showMobile">
      ...
      <div ref="dropdownGames" class="dropdown mb-4 p-4 bg-white shadow rounded-lg" @click.stop>
        <div class="flex justify-between items-center cursor-pointer" @click="showGames = !showGames">
          ...
          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="#ffd06a" :class="{'rotate-180': showGames, 'ml-2': true, 'w-6': true, 'h-6': true, 'transition-transform': true}">
            <path stroke-linecap="round" stroke-linejoin="round" d="m19.5 8.25-7.5 7.5-7.5-7.5" />
          </svg>
        </div>
        <p class="dropdown-content mt-2 p-4 bg-neutral-100 rounded-xl" v-if="showGames">
      ...
      <div ref="dropdownBestLanguage" class="dropdown mb-4 p-4 bg-white shadow rounded-lg" @click.stop>
        <div class="flex justify-between items-center cursor-pointer" @click="showBestLanguage = !showBestLanguage">
          ...
          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="#ffd06a" :class="{'rotate-180': showBestLanguage, 'ml-2': true, 'w-6': true, 'h-6': true, 'transition-transform': true}">
            <path stroke-linecap="round" stroke-linejoin="round" d="m19.5 8.25-7.5 7.5-7.5-7.5" />
          </svg>
        </div>
        <p class="dropdown-content mt-2 p-4 bg-neutral-100 rounded-xl" v-if="showBestLanguage">
      ...
      <div ref="dropdownSelfTaught" class="dropdown mb-4 p-4 bg-white shadow rounded-lg" @click.stop>
        <div class="flex justify-between items-center cursor-pointer" @click="showSelfTaught = !showSelfTaught">
          ...
          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="#ffd06a" :class="{'rotate-180': showSelfTaught, 'ml-2': true, 'w-6': true, 'h-6': true, 'transition-transform': true}">
            <path stroke-linecap="round" stroke-linejoin="round" d="m19.5 8.25-7.5 7.5-7.5-7.5" />
          </svg>
        </div>
        <p class="dropdown-content mt-2 p-4 bg-neutral-100 rounded-xl" v-if="showSelfTaught">
      ...
      <div ref="dropdownUniversity" class="dropdown mb-4 p-4 bg-white shadow rounded-lg" @click.stop>
        <div class="flex justify-between items-center cursor-pointer" @click="showUniversity = !showUniversity">
          ...
          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="#ffd06a" :class="{'rotate-180': showUniversity, 'ml-2': true, 'w-6': true, 'h-6': true, 'transition-transform': true}">
            <path stroke-linecap="round" stroke-linejoin="round" d="m19.5 8.25-7.5 7.5-7.5-7.5" />
          </svg>
        </div>
        <p class="dropdown-content mt-2 p-4 bg-neutral-100 rounded-xl" v-if="showUniversity">
      ...
      <div ref="dropdownAcademy" class="dropdown mb-4 p-4 bg-white shadow rounded-lg" @click.stop>
        <div class="flex justify-between items-center cursor-pointer" @click="showAcademy = !showAcademy">
          ...
          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="#ffd06a" :class="{'rotate-180': showAcademy, 'ml-2': true, 'w-6': true, 'h-6': true, 'transition-transform': true}">
            <path stroke-linecap="round" stroke-linejoin="round" d="m19.5 8.25-7.5 7.5-7.5-7.5" />
          </svg>
        </div>
        <p class="dropdown-content mt-2 p-4 bg-neutral-100 rounded-xl" v-if="showAcademy">
